    ...
    BEGIN
        ...
        DECLARE @RequiereFilamentoTipo BIT = 0;

        DECLARE @PrevInventarioId INT = NULL;
        DECLARE @PrevCantidad DECIMAL(10,2) = 0;
        DECLARE @PrevCostoUnitario DECIMAL(18,2) = 0;
        ...
        BEGIN TRY
            ...
            IF NOT EXISTS (SELECT 1 FROM dbo.TblComprasTipos (NOLOCK) WHERE CompraTipoId = @CompraTipoId AND EstaActivo = 1)
            BEGIN
            ...
            SELECT
                ...
                @RequiereFilamentoTipo = RequiereFilamentoTipo
            FROM dbo.TblComprasTipos (NOLOCK)
            WHERE CompraTipoId = @CompraTipoId;

            IF NOT EXISTS (SELECT 1 FROM dbo.TblComprasCategorias (NOLOCK) WHERE CompraCategoriaId = @CompraCategoriaId AND EstaActivo = 1)
            BEGIN
            ...
            IF (@RequiereFilamentoTipo = 1)
            BEGIN
                IF (@FilamentoTipoId IS NULL OR @FilamentoTipoId = 0)
                BEGIN
                    SET @message = 'Tipo de filamento es requerido para este tipo de compra.';
                    RAISERROR(@message, 16, 1);
                END
                IF NOT EXISTS (SELECT 1 FROM dbo.TblFilamentosTipos (NOLOCK) WHERE FilamentoTipoId = @FilamentoTipoId)
                BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    RAISERROR(@message, 16, 1);
                END
                IF NOT EXISTS (SELECT 1 FROM dbo.TblInventarios (NOLOCK) WHERE InventarioId = @InventarioId AND EstaActivo = 1)
                BEGIN
            ...
            ELSE
            BEGIN
                /* Si NO es inventario: CostoTotal requerido */
            ...
            BEGIN
                IF NOT EXISTS(SELECT 1 FROM dbo.TblCompras (NOLOCK) WHERE CompraId = @ElementoAlterarId)
                BEGIN
                ...
                SELECT
                    ...
                    @PrevCostoUnitario = c.CostoUnitario,
                ...
                BEGIN
                    ...
                    INSERT INTO dbo.TblInventariosMovimientos(InventarioId, TipoMovimientoId, Cantidad, Costo, FechaCreacion, UsuarioId)
                    VALUES(@PrevInventarioId, @TipoMov_REVERSA, -@PrevCantidad, -@PrevCostoTotal, GETUTCDATE(), @loginId);
                END
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    INSERT INTO dbo.TblInventariosMovimientos(InventarioId, TipoMovimientoId, Cantidad, Costo, FechaCreacion, UsuarioId)
                    VALUES(@PrevInventarioId, @TipoMov_AJUSTE, -@PrevCantidad, -@PrevCostoTotal, GETUTCDATE(), @loginId);
                END
                ...
                BEGIN
                    ...
                    INSERT INTO dbo.TblInventariosMovimientos(InventarioId, TipoMovimientoId, Cantidad, Costo, FechaCreacion, UsuarioId)
                    VALUES(@InventarioId, @TipoMov_AJUSTE, @Cantidad, @CostoTotal, GETUTCDATE(), @loginId);
                END

                UPDATE dbo.TblCompras
                    SET Descripcion = @Descripcion,
                        CompraTipoId = @CompraTipoId,
                        FilamentoTipoId = @FilamentoTipoId,
            ...
            BEGIN
                ...
                INSERT INTO dbo.TblInventariosMovimientos(InventarioId, TipoMovimientoId, Cantidad, Costo, FechaCreacion, UsuarioId)
                VALUES(@InventarioId, @TipoMov_COMPRA, @Cantidad, @CostoTotal, GETUTCDATE(), @loginId);
            END
